    ...
    modules::{
        auth::{
            dto::{
                ...
                CredentialsRequest, RolePermissionsResponse, UpdateRolePermissionsRequest,
                UserResponse,
            },
        ...
        libraries::{
            dto::{
                ...
                PreviewGenerationTaskResponse, PreviewGenerationTaskStatus,
                UpdateLibraryPreviewConfigRequest, UpdateLibraryRequest,
            },
        ...
        tasks::{
            dto::{DeleteTasksResponse, TaskResponse, TaskStatus},
...
#[openapi(
    paths(
        ...
        auth_handlers::update_role_permissions,
        ...
        video_handlers::start_cover_generation,
